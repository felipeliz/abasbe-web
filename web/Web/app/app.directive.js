    ...
    .directive('sidebarPrimaryToggle', [
        ...
        function ($rootScope, $window, $timeout) {
            return {
                ...
                replace: true,
                scope: true,
                template: '<a id="sSwitch_primary" href="#" class="sSwitch sSwitch_left" ng-click="togglePrimarySidebar($event)"><span class="sSwitchIcon"></span></a>',
            ...
            return {
                ...
                controller: function ($scope, $element) {
                    ...
                    $scope.updateInput = function () {
                        ...
                        $scope.$watch(function () { return $elem.val() }, function () {
                            var type = $elem.prop("tagName");
                            if ($elem.val() != '' || type == 'SELECT') {
